...
template_mxd = arcpy.mapping.MapDocument(TEMPLATEDIR + "nfseg_props_template.mxd")
...
with open(cpath_py_upper+"/"+file_DIS,"r") as dis:
    ...
    # !!!PMB 20190723!!! Possible to make these repeated loops a function(?)
    for row in range(1,int(NROW)+1):
        curcol=0
        while curcol<(int(NCOL)):
...
if RCH_lines[4][:10]!="OPEN/CLOSE":   # !!!PMB 201090722!!! changed <> to !=
...
if RCH_lines[6][:10]!="OPEN/CLOSE":   # !!!PMB 201090722!!! changed <> to !=
